...
from formulariodelogin import app, db, bcrypt
from formulariodelogin.forms import FormLogin, FormCriarConta, FormEditarPerfil
from formulariodelogin.models import Usuario
